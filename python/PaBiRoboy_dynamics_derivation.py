...
theta0, theta1, theta2, theta3 = dynamicsymbols('theta0, theta1, theta2, theta3')

hip_frame.orient(inertial_frame, 'Body', [0, 0, 0], 'XYX')
hip_frame.dcm(inertial_frame)

upper_leg_left_frame.orient(hip_frame, 'Axis', (theta0, -hip_frame.z))
simplify(upper_leg_left_frame.dcm(inertial_frame))

lower_leg_left_frame.orient(upper_leg_left_frame, 'Axis', (theta1, -upper_leg_left_frame.z))
...
hip_center.set_pos(origin, (0 * inertial_frame.y)+(0 * inertial_frame.x))
...
omega0, omega1, omega2, omega3 = dynamicsymbols('omega0, omega1, omega2, omega3')
...
hip_frame.set_ang_vel(inertial_frame,         0 * inertial_frame.z)
hip_frame.ang_vel_in(inertial_frame)

upper_leg_left_frame.set_ang_vel(hip_frame,   -omega0     * inertial_frame.z)
upper_leg_left_frame.ang_vel_in(inertial_frame)

lower_leg_left_frame.set_ang_vel(upper_leg_left_frame,   -omega1     * inertial_frame.z)
lower_leg_left_frame.ang_vel_in(inertial_frame)

upper_leg_right_frame.set_ang_vel(hip_frame,             omega2     * inertial_frame.z)
upper_leg_right_frame.ang_vel_in(inertial_frame)

lower_leg_right_frame.set_ang_vel(upper_leg_right_frame, omega3     * inertial_frame.z)
...
coordinates = [theta0, theta1, theta2, theta3]
coordinates

speeds = [omega0, omega1, omega2, omega3]
speeds
