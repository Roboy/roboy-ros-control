...
SphericalWrapping::SphericalWrapping(): IViaPoints(math::Vector3(0,0,0), Type::SPHERICAL), stateMachine(StateMachine()),
...
SphericalWrapping::SphericalWrapping(math::Vector3 point): SphericalWrapping()
{
    localCoordinates = point;
};

SphericalWrapping::SphericalWrapping(math::Vector3 point, double radius, int state, int counter): SphericalWrapping(point)
{
    this->radius = radius;
