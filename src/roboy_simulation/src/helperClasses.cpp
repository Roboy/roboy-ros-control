...
void controllerParametersToMessage(ControllerParameters &params, roboy_simulation::ControllerParameters &msg){
...
void messageTocontrollerParameters(const roboy_simulation::ControllerParameters::ConstPtr &msg,
    ...
    params.psi_heading = msg->psi_heading;
    params.omega_heading = msg->omega_heading;
    params.v_forward = msg->v_forward;
    params.v_COM = msg->v_COM;
    params.k_v = msg->k_v;
    params.k_h = msg->k_h;
